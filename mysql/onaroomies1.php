...
$sql = 'SELECT firstname, lastname, gender FROM attendee';
...
<meta charset="utf-8">
<title>ONARoomies:because conferences can get expensive</title>
</head>
<center><h1>O HAI ONA ROOMIE!</h1>
<body>
<p>A total of <?php echo $numRows; ?> badass potential roommates were found.</p>
<table>
  <tr>
    <th>firstname</th>
    <th>lastname</th>
